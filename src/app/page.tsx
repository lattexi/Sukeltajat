...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Sukeltamista hyvässä seurassa jo vuodesta 1976. Tutkimme hylkyjä Suomenlahdella.",
    type: "website",
    images: ["/og-image.svg"],
  },
  alternates: {
...
const organizationLD = {
  ...
  "@type": "Organization",
  name: "Sukeltajat ry",
  alternateName: "Helsingin Sukeltajaseura",
  url: getBaseUrl(),
  logo: getBaseUrl() + "/logo.png",
  foundingDate: "1976",
  description:
    "Sukeltajaseura joka tutkii hylkyjä Suomenlahdella tukialuksensa MS Maijan avulla",
  address: {
    "@type": "PostalAddress",
  ...
  sameAs: [
    "https://www.facebook.com/sukeltajat.ry",
    "https://www.instagram.com/sukeltajat_ry",
  ],
  knowsAbout: [
    "Sukeltaminen",
    "Hylkytutkimus",
...
const websiteLD = {
  ...
  name: "Sukeltajat ry",
  url: getBaseUrl(),
  description: "Sukeltajat ry - Helsingin sukeltajaseura vuodesta 1976",
  inLanguage: "fi-FI",
  potentialAction: {
    "@type": "SearchAction",
    target: getBaseUrl() + "/haku?q={search_term_string}",
        ...
        <section className="relative bg-gradient-to-r from-blue-900 via-blue-800 to-indigo-900 text-white py-28 lg:py-36 overflow-hidden">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h1
                className="text-5xl md:text-7xl lg:text-8xl font-bold mb-10 text-white drop-shadow-2xl"
